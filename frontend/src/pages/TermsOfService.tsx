import PolicyHeader from "../components/utils/PolicyHeader";
  ...
  return (
    <div className="px-12">
      ...
      <div className="policy">
        ...
        <p>Welcome to phaero.net!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Phaero&apos;s Website, located at https://phaero.net.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use phaero.net if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing phaero.net, you agreed to
          use cookies in agreement with the Phaero&apos;s Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Phaero and/or its licensors own the
          intellectual property rights for all material on phaero.net. All
          intellectual property rights are reserved. You may access this from
          phaero.net for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from phaero.net</li>
          <li>Sell, rent or sub-license material from phaero.net</li>
          <li>Reproduce, duplicate or copy material from phaero.net</li>
          <li>Redistribute content from phaero.net</li>
        </ul>
        ...
        <p>
          ...
          the hyperlink compensates the absence of Phaero; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to Phaero. Please include your name, your
        ...
        <p>
          No use of Phaero&apos;s logo or other artwork will be allowed for
