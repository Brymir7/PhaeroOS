    ...
    <div className="px-12">
      ...
      <div className=" policy">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Phaero, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Phaero, Beyschlagstraße 7.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Sachsen-Anhalt, Germany
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to phaero.net, accessible from{" "}
              <a
                href="https://phaero.net"
        ...
        <ul>
          <li>
            <p>By email: PhaeroAI@gmail.com</p>
          </li>
          <li>
            <p>By phone number: 01738345939</p>
          </li>
        </ul>
      </div>
    </div>
