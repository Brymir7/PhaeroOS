...
export default function AuthPage() {
  ...
  return (
    <div
      className={`min-h-full h-[100vh] flex items-center bg-custom justify-center px-4 sm:px-0 lg:px-8 `}
    >
      <Paper
        elevation={3}
        className="max-w-md w-full bright-div space-y-1  p-4 rounded-lg  max-h-[95vh] overflow-y-auto "
      >
        {isLogin ? (
          <>
            <Header
